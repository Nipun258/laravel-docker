          ...
          <div class="col-md-12">
            ...
            @endauth
              <div class="card-header">
                <h3 class="card-title"><a href="{{ URL::previous() }}"><i class="fa fa-arrow-circle-left" aria-hidden="true" style="font-size: 30px;"></i></a> Study Board Subject Edit Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{ route('study.board.subject.update',$editData->id) }}">
                @csrf
                <div class="card-body">
                   <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select name="study_board_id" id="study_board_id" class="select2bs4" style="width: 100%">
                            ...
                            <option value="{{ $studyBoard->id}}" {{  $studyBoard->id == $editData->study_board_id ? 'selected' : '' }}>{{ $studyBoard->name}}</option>
                            @endforeach
                        </select>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="">Study Board Subject Name<span class="text-danger"> *</span></label>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('study.board.subject.index') }}" class="btn {{ auth()->user()->sidebar_color == 'yellow' ? 'btn-dark' : 'btn-warning'}}">Cancel</a>
                    @endauth
                    </div>
                @endcan
